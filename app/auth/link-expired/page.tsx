  ...
  return (
    <Card className="auth-card border-0 shadow-2xl backdrop-blur-sm rounded-2xl overflow-hidden">
      <CardContent className="p-6 sm:p-8 text-center">
        ...
        {/* Expired Icon - menggunakan image sebagai icon utama */}
        <div className="w-20 h-20 mx-auto mb-8 rounded-2xl flex items-center justify-center shadow-lg animate-scale-in animate-expired-shake overflow-hidden">
          <Image
            src="/token-email-expired.png"
            alt="Link Expired"
            width={80}
            height={80}
