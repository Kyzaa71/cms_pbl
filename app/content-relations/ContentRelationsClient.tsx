 ...
 export default function ContentRelationsClient() {
         ...
         <table className="w-full border-collapse text-sm">
           ...
           <tbody>
             {filteredRelations.length > 0 ? (
                 ...
                 >
                   ...
                   <td className="py-3 px-4 text-center">
                     <div className="flex items-center justify-center gap-2">
                       <Button variant="ghost" size="icon" onClick={() => handleView(relation.from_content_id)} title="View">
                         <Eye className="w-4 h-4" />
                       </Button>
                       {canModifyRelations && (
                         <Button variant="ghost" size="icon" onClick={() => handleDelete(relation.id)} title="Delete">
               ...
               <tr>
                 <td className="py-6 px-4 text-center text-[var(--muted-foreground)]" colSpan={5}>
                   No relations found.
                 </td>
               </tr>
             )}
