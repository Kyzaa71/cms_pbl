...
import { formatSlug } from "@/components/content-builder/types";
...
export default function CreateContentTypePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // In a real app, this would call: POST /content/types
    console.log("Create content type:", { name, slug, enable_seo: enableSeo });
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--muted-foreground)]">
                Define a new content schema for your CMS
              </p>
            </div>
          </div>
          <Link href="/content-builder">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--muted-foreground)]">
              Used for API routes. Must be unique and URL-friendly (lowercase, hyphens only)
            </p>
          </div>
